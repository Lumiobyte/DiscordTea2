...
async def on_ready():
    ...
    activity = discord.Game(name = 'with tea | tea!help | v2.0.1')
...
``tea!blacklist <add/remove> <user>`` - Blacklist or unblacklist a user.
    ...
    embedToSend.set_footer(text = 'Discord Tea v2.0.1 by Lumiobyte#0867 - Check tea!changelog for update changelog')
